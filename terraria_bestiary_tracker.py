...
BESTIARY = [
    ...
    (36, "Mystic Slime", "Mystic_Slime", ["TownSlimeYellow"], False),
    ...
    (82, "Mallard Duck", "Mallard_Duck", ["Duck2", "DuckWhite"], False),
    ...
    (182, "Statue", "Statue", ["ArmedZombie", "ArmedZombiePincushion", "ArmedZombieTwiggy", "ArmedZombieSwamp", "ArmedZombieCenx"], False),
    # ── Underground / Cavern ──
    ...
    (238, "Giant Antlion Charger", "Giant_Antlion_Charger", ["WalkingAntlion"], False),
    ...
    (245, "Giant Antlion Swarmer", "Giant_Antlion_Swarmer", ["FlyingAntlion", "GiantFlyingAntlion"], False),
    ...
    # ── Old One's Army ──
    (392, "Old One's Skeleton", "Old_One's_Skeleton", ["DD2SkeletonT1"], False),
    ...
    (469, "Slime (bunny_mask)", "Slime", ["SlimeBunnyMask"], False),
    (470, "Demon Eye (spaceship)", "Demon_Eye", ["DemonEyeSpaceship"], False),
    (471, "Demon Eye (owl_mask)", "Demon_Eye", ["DemonEyeOwlMask"], False),
    (472, "Zombie (doctor)", "Zombie", ["ZombieDoctor"], False),
    (473, "Zombie (superman)", "Zombie", ["ZombieSuperman"], False),
    (474, "Zombie (pixie)", "Zombie", ["ZombieFairy"], False),
    (475, "Skeleton (astronaut)", "Skeleton", ["SkeletonAstonaut"], False),
    (476, "Skeleton (alien)", "Skeleton", ["SkeletonAlien"], False),
    (477, "Skeleton (top_hat)", "Skeleton", ["SkeletonTopHat"], False),
    # ── Seasonal costume variants (Christmas) ──
    (478, "Slime (red_present_slime)", "Slime", ["SlimeXmasRed"], False),
    (479, "Slime (yellow_present_slime)", "Slime", ["SlimeXmasYellow"], False),
    (480, "Slime (white_present_slime)", "Slime", ["SlimeXmasWhite"], False),
    (481, "Slime (green_present_slime)", "Slime", ["SlimeXmasGreen"], False),
    ...
    (486, "Mister Stabby", "Mister_Stabby", ["MrStabby"], False),
    # ── Nebula Pillar ──
    ...
    (493, "Drakanian", "Drakanian", ["SolarDrakanian"], True),
    ...
    (500, "Vortexian", "Vortexian", ["Vortexian"], True),
    (501, "Storm Diver", "Storm_Diver", ["VortexSoldier"], True),
    (502, "Alien Queen", "Alien_Queen", ["VortexHornetQueen"], True),
    # ── Stardust Pillar ──
    (503, "Stargazer", "Stargazer", ["StargazerLobber"], True),
    ...
    (539, "Blue Cultist Archer", "Blue_Cultist_Archer", ["CultistArcher"], True),
    (540, "Ancient Vision", "Ancient_Vision", ["AncientCultistSquidhead"], True),
    (541, "Phantasm Dragon", "Phantasm_Dragon", ["CultistDragonHead"], True),
    # ── Celestial Pillars ──
